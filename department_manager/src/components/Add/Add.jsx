    ...
    <>
       <form id= {styles.form} onSubmit= {handleSubmit}>
         <h2>Add Resident's Information here</h2>
            ...
            <input type="text" name= "image" placeholder='Add Image Url' onChange= {handleChange}/>
            <input type="text" name= "contact_no" placeholder='Add Contact Number' onChange= {handleChange}/>
            <input type="text" name= "type" placeholder='Owner Type' onChange= {handleChange}/>
            <input type="text" name= "wing" placeholder='Enter Wing' onChange= {handleChange}/>
            <input type="text" name= "room_no" placeholder='Enter Room Number' onChange= {handleChange}/>
